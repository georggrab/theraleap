...
export const device = {
    ...
    getters: {
        ...
        getDeviceDataTransferRate: (state: DeviceState) => state.deviceDataTransferRate,
    ...
    mutations: {
        ...
        updateDeviceDataTransferRate: (state: DeviceState, transferRate: number) => {
...
export const getDeviceDataTransferRate = read(device.getters.getDeviceDataTransferRate);
...
export const updateDeviceDataTransferRate = commit(device.mutations.updateDeviceDataTransferRate);